        ...
        <div class="col-md-8 border-right">
          <div class="p-3">
            <div class="d-flex justify-content-between align-items-center mb-3">
              <h4 class="text-right">Lihat Mentor</h4>
            </div>
            <div class="row mt-2">
              <div class="col-md-6">
            ...
            <div class="mt-5" v-if="action == 'approval'">
              <button
                class="btn btn-success"
                type="button"
                @click="approveMentor(1)"
              >
                Approve
              </button>
              <button
...
export default defineComponent({
  ...
  methods: {
    ...
    approveMentor(status: any) {
      let uri = window.location.href;
      let id = uri.substring(uri.lastIndexOf("/") + 1);

      axios
        .post(
          "http://localhost:5000/admin/approval-mentor",
          {
            mentor_id: id,
            is_approved: status,
          },
